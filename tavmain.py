...
@st.cache 
def load_database():
    return pd.read_feather('base/gs.feather'), \
        pd.read_feather('base/classificacaoz_consumidor.feather')
...
with taberp:
    ...
    consumidor = st.selectbox('Selecione um Consumidor', gs['Customer ID'].unique())
